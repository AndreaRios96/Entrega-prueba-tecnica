...
INSERT INTO `comands` VALUES (1,'linux','hostname -I | awk \'{print $1}\'','hostname','free | grep Mem | awk \'{print ($3/$2 * 100.0)}\'','top -bn1 | grep \"Cpu(s)\" | awk \'{print 100 - $8}\'','df -h | grep -vE \'^Filesystem | tmpfs | cdrom \' | awk \'{print $5 \"\" $6}\'');
